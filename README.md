...
Modules [`es.function.name`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.function.name.js) and [`es.function.has-instance`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.function.has-instance.js).
```js
class Function {
  name: string;
...
Modules [`es.aggregate-error`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.aggregate-error.js), [`es.promise.constructor`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.js), [`es.promise.all`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.all.js), [`es.promise.all-settled`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.all-settled.js), [`es.promise.any`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.any.js), [`es.promise.catch`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.catch.js), [`es.promise.finally`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.finally.js), [`es.promise.race`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.race.js), [`es.promise.reject`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.reject.js) and [`es.promise.resolve`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/es.promise.resolve.js).
```js
...
Modules [`esnext.array.at`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/esnext.array.at.js), [`esnext.string.at`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/esnext.string.at.js) and [`esnext.typed-array.at`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/esnext.typed-array.at.js)
...
Modules [`web.set-interval`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/web.set-interval.js) and [`web.set-timeout`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/web.set-timeout.js). Additional arguments fix for IE9-.
```js
...
```
#### `setImmediate`[⬆](#index)
Modules [`web.clear-immediate`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/web.clear-immediate.js) and [`web.set-immediate`](https://github.com/zloirock/core-js/blob/v3.10.0/packages/core-js/modules/web.set-immediate.js). [`setImmediate`](http://w3c.github.io/setImmediate/) polyfill.
```js
